...
function [ ] = createRabiTypeSternGerlachFEMMSimplifiedModifiedGeometry(type, meshSize, enforcedBoundaryPotential, folder, fileName, geometry)
% Add femm path to MATLAB
addpath C:\femm42\mfiles\

modelname='RabiTypeSternGerlachSimplifiedModifiedGeometry';
