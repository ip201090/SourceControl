...
function varargout = mp_op_gradu_gradv_tp (space1, space2, msh, coeff, patch, npatch)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    A = A + op_gradu_gradv (sp1_col, sp2_col, msh_col, coeff (x{:}, patch, iel, npatch, msh.nel_dir(1)));
  end
