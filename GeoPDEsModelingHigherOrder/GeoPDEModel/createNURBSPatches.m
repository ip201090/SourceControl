...
function [convexnrb, concavenrb] = createNURBSPatches(knotRefinementHorizontal,knotRefinementVertical,optionalPlots, geometry)

% Knot vectors
lowermostKnot=0.9;
%additionalKnotsVertical=sort([ 0.25 0.65 0.3688 0.8500 0.9175]);
additionalKnotsVertical=[];
%addKnots=linspace(0.8, 1.0, 5);
%additionalKnotsVertical=[addKnots(2:end-1)];
%additionalKnotsHorizontal=sort([0.450 0.9500]);
additionalKnotsHorizontal=[];
%additionalKnotsHorizontal=[0.22, 0.44, 0.66, 0.88];
...
concavenrb.coefs(1:3,7)=concavenrb.coefs(1:3,7)*(concavenrb.coefs(4,7))/(concavenrb.coefs(4,7)-wDisplacement3);
...
concavenrb.coefs(1:3,6)=concavenrb.coefs(1:3,6)*(concavenrb.coefs(4,6))/(concavenrb.coefs(4,6)-wDisplacement4);
...
% Reverse the vertical direction of evaluation
nurbsAirGapPatch=nrbreverse(nurbsAirGapPatch, 2);
nurbsLeftPolePatch=nrbreverse(nurbsLeftPolePatch, 2);
nurbsRightPolePatch=nrbreverse(nurbsRightPolePatch, 2);
